...
const drinks = [
  { icon: CupSoda, name: "Sake", slug: "sake", price: "$3", desc: "A warm cup of junmai." },
  { icon: Beer, name: "Draft Beer", slug: "draft-beer", price: "$5", desc: "Kirin on tap." },
  { icon: Wine, name: "Yuzu Highball", slug: "yuzu-highball", price: "$7", desc: "House special." },
];
