// Independent badge for InnovationSection — same design as TicketBadge
...
export default function InnovationBadge() {
  ...
  return (
    <div className="relative inline-flex items-center" style={{ height: `${H}px`, width: `${totalW}px` }}>
      <svg
      ...
      >
        <path fill="#EBEBEB" d={leftPath} />
        <path fill="#EBEBEB" d={rightPath} />
      </svg>
